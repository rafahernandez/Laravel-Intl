...
if (! function_exists('country')) {
     ...
     * @return \RafaHernandez\LaravelIntl\Country|string
     */
...
if (! function_exists('currency')) {
     ...
     *
     * @return \RafaHernandez\LaravelIntl\Currency|string
     */
    function currency()
    {
...
if (! function_exists('language')) {
     ...
     * @return \RafaHernandez\LaravelIntl\Language|string
     */
...
if (! function_exists('number')) {
     ...
     * @param array $options
     * @return \RafaHernandez\LaravelIntl\Number|string
     */
